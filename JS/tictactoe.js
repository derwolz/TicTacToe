...
function startGame() {
    ...
    var btn = document.getElementById('btnStart'); //disable the start button since game has started
    btnDisabled(btn);
    var btn = document.getElementById('btnStop'); // enable stop button
    stopEnabled(btn);
        
    var showPlayer = document.getElementById("showPlayer") // assign active player to console
...
function startEnabled(btn) {
    btn.style.color = '#fff';
    btn.style.border = '2px soslid rgb(0, 153, 0';
    btn.style.backgroundColor = 'rgb(57, 230, 0)';
    btn.disabled = false;
}
...
function stopGame() {
    ...
    var arrayO = document.getElementsByClassName("O");// clear squares
    ...
    document.getElementById("boardState").innerHTML = ''; //Clear running log of game moves
}
...
function avatarPlaced() {
    var parsText = document.getElementById('gameMsg').innerHTML;
    var showPlayer = document.getElementById('showPlayer');
    if (parsText == "That's three in a row, Player 1 wins!" || parsText == "That's three in a row, Player 2 wins") {
        showPlayer.innerHTML = "Game Stopped";
        showPlayer.style.color = 'red';
    }
...
function check4Tie() {
    var boardState = document.getElementById('boardState').innerHTML;
    boardState = boardState.substring(1); // remove initial ,
...
function glowBoard(pos) {
    ...
    if (i == index0) {
        ...
        setTimeout(function() {bg1.style.backgroundColor = 'rgb(244,179,235)';}, 500)
        setTimeout(function() {bg1.style.backgroundColor = 'rgb(244,238,66)';}, 600)
        setTimeout(function() {bg1.style.backgroundColor = 'rgb(197,244,66)';}, 700)
        setTimeout(function() {bg1.style.backgroundColor = 'rgb(122,244,66)';}, 800)
        setTimeout(function() {bg1.style.backgroundColor = 'rgb(66,244,235)';}, 900)
        ...
        setTimeout(function() {bg2.style.backgroundColor = 'rgb(244,238,66)';}, 600)
        setTimeout(function() {bg2.style.backgroundColor = 'rgb(197,244,66)';}, 700)
        ...
        setTimeout(function() {bg3.style.backgroundColor = 'rgb(244,179,235)';}, 500)
        setTimeout(function() {bg3.style.backgroundColor = 'rgb(244,238,66)';}, 600)
        setTimeout(function() {bg3.style.backgroundColor = 'rgb(197,244,66)';}, 700)
        setTimeout(function() {bg3.style.backgroundColor = 'rgb(122,244,66)';}, 800)
        setTimeout(function() {bg3.style.backgroundColor = 'rgb(66,244,235)';}, 900)
...
function blink() {
    ...
    setTimeout(function() {body.style.backgroundColor = '#c6036e';}, 900)
...
function checkWinCon5(info,squareArray) {
    ...
    if (match1Avatar != undefined && match7Avatar != undefined && match4Avatar != undefined) {
        if (match1Avatar == match7Avatar && match1Avatar == match4Avatar) {
            winDetected = "win";
...
function checkWinCon8(info,squareArray) {
    ...
    if (match6Avatar != undefined && match2Avatar != undefined && match4Avatar != undefined) {
...
function animateX(selected) {
    selected.style.transform = (selected.style.transform == "translateY(0%)" || null) ? "transateY(0%)" : "translateY(0)";
}